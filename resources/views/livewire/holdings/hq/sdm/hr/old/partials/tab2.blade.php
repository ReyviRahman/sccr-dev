<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    {{-- <x-ui.sccr-input name="tanggal_lahir" label="Tanggal Lahir" wire:model.defer="tanggal_lahir" type="date" /> --}}
    {{-- <x-ui.sccr-date name="tanggal_lahir" label="Tanggal Lahir" wire:model.defer="tanggal_lahir" /> --}}
    <x-ui.sccr-input name="tanggal_lahir" label="Tanggal Lahir" wire:model="tanggal_lahir" type="date" />
