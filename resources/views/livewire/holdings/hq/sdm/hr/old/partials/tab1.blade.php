<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <x-ui.sccr-input name="nip" label="NIP" wire:model="nip" :required="true" placeholder="Contoh: 20180205 1 001" />

    <x-ui.sccr-input name="gelar_depan" label="Gelar Depan" wire:model="gelar_depan" placeholder="Contoh: Prof. DR. Ir. dr." />
    <x-ui.sccr-input name="nama" label="Nama Lengkap" wire:model="nama" :required="true" placeholder="Nama lengkap" />
    ...
    <x-ui.sccr-select name="division_id" label="Division" wire:model="division_id" :required="true" :options="$divisions->pluck('name', 'id')->toArray()" />
    ...
    {{-- <x-ui.sccr-input name="tanggal_join" label="Tanggal Masuk" wire:model="tanggal_join" type="date"
        :required="true" /> --}}
