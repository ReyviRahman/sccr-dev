...
<div>
    <form wire:submit.prevent="save" class="space-y-4">
        ...
        <x-ui.sccr-input name="nama" label="Nama" wire:model="nama" :required="true" placeholder="Nama lengkap" />
        ...
        <x-ui.sccr-input name="tanggal_join" label="Tanggal Join" wire:model="tanggal_join" type="date"
            :required="true" />
        ...
        <x-ui.sccr-toast :show="$showCancelConfirm" type="warning" message="Yakin batal tambah data?" />
