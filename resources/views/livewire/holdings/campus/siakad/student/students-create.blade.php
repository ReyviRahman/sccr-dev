<div>
    <form wire:submit.prevent="save" class="space-y-4">
        ...
        {{-- MODAL LAYOUT --}}
        <x-ui.sccr-modal-layout title="Add New Student" :groups="[
            'tab1' => 'Personal Data',
            'tab2' => 'Academic Info',
        ...
        {{-- TOAST --}}
        <x-ui.sccr-toast :show="$showCancelConfirm" type="warning" message="Are you sure you want to cancel adding this student?" />
