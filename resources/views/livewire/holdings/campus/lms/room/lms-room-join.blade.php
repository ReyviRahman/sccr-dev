<x-ui.sccr-card wire:key="lms-room-join">
    ...
    <div class="relative py-4 bg-cyan-600 rounded-b-3xl shadow-lg text-white z-10">
        ...
        <x-ui.sccr-breadcrumb :items="$breadcrumbItems" />
    ...
    <div class="px-4 py-6 space-y-4">
        @if ($room)
            <x-ui.sccr-card class="bg-white shadow">
            ...
            <div class="mt-6">
                ...
                @else
                    <x-ui.sccr-button wire:click="joinRoom" variant="primary">Gabung Sekarang</x-sccr-button>
                @endif
            </div>
        @else
            <div class="text-center py-12 text-gray-600">
                ...
                <x-ui.sccr-button :href="route('holdings.campus.lms.room.create')" variant="primary" class="mt-4">
                    Buat Room Baru
                </x-sccr-button>
            </div>
        @endif
