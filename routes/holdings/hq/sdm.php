...
use App\Livewire\Holdings\Hq\Sdm\Hr\EmployeeAffairs;
...
Route::prefix('holdings/hq/sdm/hr')
    ...
    ->group(function () {
        ...
        // AFFAIRS (unlock/resign/cuti)
        Route::get('/{nip}/affairs', EmployeeAffairs::class)
...
use App\Livewire\Holdings\Hq\Sdm\Hr\AbsensiMonitoring;
use App\Livewire\Holdings\Hq\Sdm\Hr\AbsensiPwa;
...
Route::prefix('holdings/hq/sdm/hr/absensi')
    ...
    ->group(function () {
        ...
        Route::get('/monitoring', AbsensiMonitoring::class)
            ->name('monitoring')
            ->middleware('authorize.permission:ABS_HRD_MONITOR');

        Route::get('/pwa', AbsensiPwa::class)
            ->name('pwa')
            ->middleware('authorize.permission:ABS_CREATE');
    });
