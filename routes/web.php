...
use App\Livewire\Employee\EmployeeDashboard as EmployeePersonalDashboard;
use App\Livewire\Holdings\Hq\Sdm\Hr\AbsensiScanner;
...
/*
|--------------------------------------------------------------------------
| PUBLIC - ABSENSI SCANNER (Kiosk Mode)
|--------------------------------------------------------------------------
*/
Route::get('/absensi/scanner', AbsensiScanner::class)
    ->name('absensi.scanner');

Route::get('/employee/dashboard', EmployeePersonalDashboard::class)
