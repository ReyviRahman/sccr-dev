...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        $middleware->alias([
            ...
            // NEW: device webhook middleware
            'device.ip.whitelist' => \App\Http\Middleware\DeviceIpWhitelist::class,
            'device.webhook.auth' => \App\Http\Middleware\DeviceWebhookAuth::class,
        ]);
    })
